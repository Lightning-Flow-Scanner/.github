...
- ✨ [Comprehensive Best Practices Analysis](https://github.com/Force-Config-Control/lightning-flow-scanner-core): Ensure your Flows adhere to the latest Best Practices through Static Analysis.
